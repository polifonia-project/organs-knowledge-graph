...
cat ../organs-dataset/output/organids_nl.txt | xargs -I oid fx -q organs-dispositions.sparql -values organ="oid" -values filepath="../organs-dataset/output/kg/kg_dispositions.json" >> kg/organ-nl-dispositions.ttl
rm kg/organ-nl-dispositions-cstops.ttl
cat ../organs-dataset/output/organids_nl.txt | xargs -I oid fx -q organs-dispositions_cstops.sparql -values organ="oid" -values filepath="../organs-dataset/output/kg/kg_dispositions.json" >> kg/organ-nl-dispositions-cstops.ttl
...
fx -q organs-pictures.sparql -values filepath="../organs-dataset/Italian/output/kg/kg_it_pictures.json" > kg/organ-it-pictures.ttl
fx -q organs-projects.sparql -values filepath="../organs-dataset/Italian/output/kg/kg_it_projects.json" > kg/organ-it-projects.ttl
